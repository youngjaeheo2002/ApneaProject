...
def extract_sleep_periods(path_and_name):
    ...
    print(f"dumping into {SCRATCH}/sleep_periods/{name}.pkl...")
    with open(f'{SCRATCH}/sleep_periods/{name}.pkl', 'wb') as f:
        pickle.dump(positive_sections, f)
    print(f"Finished dumping into {name}.pkl",flush = True)
...
if __name__ == '__main__':
    t0 = datetime.now()
    print(f'non-sleep April 12th code removal started at {t0}',flush = True)
